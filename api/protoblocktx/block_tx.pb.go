...
type Tx struct {
	...
	Signature  []byte         `protobuf:"bytes,2,opt,name=signature,proto3" json:"signature,omitempty"`   // The signature on the namespaces.
}
...
var file_api_protoblocktx_block_tx_proto_rawDesc = []byte{
	...
	0x03, 0x74, 0x78, 0x73, 0x22, 0x5d, 0x0a, 0x02, 0x54, 0x78, 0x12, 0x39, 0x0a, 0x0a, 0x6e, 0x61,
