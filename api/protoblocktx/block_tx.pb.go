...
type TxNamespace struct {
	...
	NsId uint32 `protobuf:"varint,1,opt,name=ns_id,json=nsId,proto3" json:"ns_id,omitempty"` // The namespace ID. Only 256 namespaces are supported, i.e., from 0 to 255.
...
func (x *TxNamespace) GetNsId() uint32 {
	if x != nil {
		return x.NsId
	}
	return 0
...
var file_api_protoblocktx_block_tx_proto_rawDesc = []byte{
	...
	0x75, 0x6d, 0x62, 0x65, 0x72, 0x2a, 0xd4, 0x02, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73,
	...
	0x5f, 0x4e, 0x4f, 0x5f, 0x57, 0x52, 0x49, 0x54, 0x45, 0x53, 0x10, 0x0a, 0x42, 0x51, 0x5a, 0x4f,
	...
	0x70, 0x69, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x74, 0x78, 0x62,
