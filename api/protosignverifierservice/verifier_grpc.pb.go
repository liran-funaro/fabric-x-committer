...
func (c *verifierClient) SetVerificationKey(ctx context.Context, in *Key, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/protosignverifierservice.Verifier/SetVerificationKey", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *verifierClient) StartStream(ctx context.Context, opts ...grpc.CallOption) (Verifier_StartStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &Verifier_ServiceDesc.Streams[0], "/protosignverifierservice.Verifier/StartStream", opts...)
	if err != nil {
		return nil, err
	}
...
func _Verifier_SetVerificationKey_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protosignverifierservice.Verifier/SetVerificationKey",
	}
...
var Verifier_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "protosignverifierservice.Verifier",
	...
	Metadata: "api/protosignverifierservice/verifier.proto",
}
