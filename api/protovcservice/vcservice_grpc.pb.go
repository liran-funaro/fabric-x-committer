...
func (c *validationAndCommitServiceClient) StartValidateAndCommitStream(ctx context.Context, opts ...grpc.CallOption) (ValidationAndCommitService_StartValidateAndCommitStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &ValidationAndCommitService_ServiceDesc.Streams[0], "/protovcservice.ValidationAndCommitService/StartValidateAndCommitStream", opts...)
	if err != nil {
		return nil, err
	}
