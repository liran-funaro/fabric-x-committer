...
| sidecar_delivery_stream_starts_total                       | counter   | stream_type source_id            | Total number of stream starts by stream typem and source ID.                                                                                             |
...
| Name                                              | Type    | Labels    | Description                                          |
|---------------------------------------------------|---------|-----------|------------------------------------------------------|
| verifier_server_tx_throughput                     | counter | direction | Incoming requests/Outgoing responses for a component |
