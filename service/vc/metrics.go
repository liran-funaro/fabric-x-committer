...
func newVCServiceMetrics(q *queues) *perfMetrics {
	...
	return &perfMetrics{
		...
		batcherInputQueueSize: monitoring.NewChannelLenGauge(p, prometheus.GaugeOpts{
			Namespace: namespace,
			Subsystem: "batcher",
		...
		validatorInputQueueSize: monitoring.NewChannelLenGauge(p, prometheus.GaugeOpts{
			Namespace: namespace,
			Subsystem: subsystemValidator,
			Name:      nameInputQueueSize,
			Help:      "The validator input queue size",
		}, q.preparedTxs),
		committerInputQueueSize: monitoring.NewChannelLenGauge(p, prometheus.GaugeOpts{
			Namespace: namespace,
			Subsystem: subsystemCommitter,
			Name:      nameInputQueueSize,
			Help:      "The committer input queue size",
		}, q.validatedTxs),
		txStatusOutputQueueSize: monitoring.NewChannelLenGauge(p, prometheus.GaugeOpts{
			Namespace: namespace,
			Subsystem: "txstatus",
